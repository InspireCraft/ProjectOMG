...
class PlayerCharacter(arcade.Sprite):
    def __init__(self):
        ...
        self.idle_textures_down = load_texture(f"{main_path}/Idle/idleDown.png")
        self.idle_textures_up = load_texture(f"{main_path}/Idle/idleUp.png")
        self.idle_textures_right = load_texture(f"{main_path}/Idle/idleRight.png")
        self.idle_textures_left = load_texture(f"{main_path}/Idle/idleLeft.png")
        ...
        for i in range(8):
            texture = load_texture(f"{main_path}/Walk/walkDown{i}.png")
            self.walk_textures_down.append(texture)
            texture = load_texture(f"{main_path}/Walk/walkUp{i}.png")
            self.walk_textures_up.append(texture)
            texture = load_texture(f"{main_path}/Walk/walkRight{i}.png")
            self.walk_textures_right.append(texture)
            texture = load_texture(f"{main_path}/Walk/walkLeft{i}.png")
            self.walk_textures_left.append(texture)
        
        # Load textures for running
        self.run_textures_down = []
        self.run_textures_up = []
        self.run_textures_right = []
        self.run_textures_left = []
        for i in range(7):
            texture = load_texture(f"{main_path}/Run/Down{i}.png")
            self.run_textures_down.append(texture)
            texture = load_texture(f"{main_path}/Run/Up{i}.png")
            self.run_textures_up.append(texture)
            texture = load_texture(f"{main_path}/Run/Right{i}.png")
            self.run_textures_right.append(texture)
            texture = load_texture(f"{main_path}/Run/Left{i}.png")
            self.run_textures_left.append(texture)
    ...
    def update_animation(self, delta_time: float = 1 / 60):
        ...
        if self.isRunning == 0:
            ...
            if direction == DOWN_FACING:
                self.texture = self.run_textures_down[frame]
            if direction == UP_FACING:
                self.texture = self.run_textures_up[frame]
            if direction == RIGHT_FACING:
                self.texture = self.run_textures_right[frame]
            if direction == LEFT_FACING:
                self.texture = self.run_textures_left[frame]
