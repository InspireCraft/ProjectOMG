...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        main_path = "C:/Users/Admin/Desktop/2D_Sprite_Animations/demo_2/sprites"
        # main_path = "C:/Users/Admin/Desktop/2D_Sprite_Animations/demo_spearman/sprites"
        ...
        # self.walk_textures = []
        # self.slash_textures = []
        # self.spellcast_textures = []
        # self.thrust_textures = []
        # self.shoot_textures = []
        # self.die_textures = []
    ...
    def update_animation(self, delta_time):
        ...
        if self.player_sprite.change_y < 0 and self.character_face_direction != DOWN_FACING:
            self.character_face_direction = DOWN_FACING
        ...
        if self.player_sprite.change_y > 0 and self.character_face_direction != UP_FACING:
        ...
        if self.player_sprite.change_x < 0 and self.character_face_direction != LEFT_FACING:
